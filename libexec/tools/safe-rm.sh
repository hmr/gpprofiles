...
# under MIT License.
#
# This script is safer version of `rm` command. Instead of deleting files
# permanently, it moves them to the trash/recycle bin.
# The trash location ia configurable bt env $SAFE_RM_TRASH but defaults to:
#   - MacOS: ~/.Trash
#   - Linux: ~/.local/share/Trash
#
# The configuration file should be placed at "$XDG_CONFIG_HOME/safe-rm/config".
# Sample configuration file is at "settings/apps/safe-rm/config".
#
# To use with GPP:
# $ ln -s $GPP_HOME/libexec/tools/safe-rm.sh ~/.local/bin/rm
# ==============================================================================
