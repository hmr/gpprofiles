...
# This script was imported from 'alacritty/alacritty-theme' with permission by Apache License 2.0.

echo "Escape sequence SGR (Select Graphic Rendition) color test:"
